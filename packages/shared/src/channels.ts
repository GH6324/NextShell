export const IPCChannel = {
  ...
  AgentInstallCursor: "nextshell:agent:install-cursor",
  AgentInstallClaudeDesktop: "nextshell:agent:install-claude-desktop",
  AgentExportMcpb: "nextshell:agent:export-mcpb",
